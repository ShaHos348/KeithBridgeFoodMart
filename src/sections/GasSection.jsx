      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20">
          ...
          <div className="grid md:grid-cols-5 gap-10 max-w-4xl mx-auto">
            <GasCard label="Regular" value="87" price="3.73" />
            <GasCard label="Plus" value="89" price="4.45" />
            <GasCard label="Premium" value="93" price="4.84" />
            <GasCard label="NonEthanol" value="90" price="4.69" />
            <div
            ...
            >
              ...
              <p className="font-semibold text-xl text-gray-900 mt-10">$5.35</p>
            </div>
          </div>
